...
public class Test153__different_HRSSpeakerModel_status {
  ...
  public void Different_HRSSpeakerModel_fields() throws Exception {
	...
	// Login and check the HRS Speaker Model checkbox
	...
	tempUSBHeadsetType = testFuncs.readFile("ip_1.txt");
	testFuncs.myDebugPrinting("tempUSBHeadsetType - " + tempUSBHeadsetType, testVars.logerVars.MINOR);
	testFuncs.verifyStrByXpath(driver, "//*[@id='table']/tbody[1]/tr/td[24]", tempUSBHeadsetType); 
