...
/**
* ----------------
* This test tests the multiple device actions via a Monitoring user (tenant)
* ----------------
* Tests:
...
*    1.  Verify that Delete-devices tenant is deactivated.
...
public class Test91__Monitoring_tenant_multi_devices_actions {
  ...
  public Test91__Monitoring_tenant_multi_devices_actions(browserTypes browser) {
