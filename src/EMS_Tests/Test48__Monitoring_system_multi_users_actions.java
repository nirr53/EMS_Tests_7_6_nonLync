...
*    9. Verify that Delete user-configuration is not enabled
...
public class Test48__Monitoring_system_multi_users_actions {
  ...
  public Test48__Monitoring_system_multi_users_actions(browserTypes browser) {
